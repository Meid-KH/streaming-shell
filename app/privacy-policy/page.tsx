  ...
  return (
    <section className="py-56">
      <article className="container prose">
        ...
        <p>
          <strong>{siteConfig.name}</strong> (“we,” “our,” or “us”) is committed
        ...
        <p>
          ...
          <strong>{siteConfig.name}</strong>. By accessing or using our Service,
        ...
        <ul>
          <li>
            ...
            browser, provide analytics, and remember information about you such
            as your language preference or login information.
          </li>
          <li>
            <strong>Company:</strong> When this policy mentions “Company,” “we,”
            “us,” or “our,” it refers to SERVICEDIA LTD, 71-75 SHELTON STREET,
            COVENT GARDEN LONDON WC2H 9JQ, which is responsible for your
            information under this Privacy Policy.
          </li>
          <li>
            <strong>Country:</strong> The country where{" "}
            <strong>{siteConfig.name}</strong> or the owners/founders of{" "}
            <strong>{siteConfig.name}</strong> are based. In this case, it is
            the United Kingdom.
          </li>
          <li>
            ...
            Service to manage the relationships with their consumers or service
            users.
          </li>
          <li>
          ...
          <li>
            <strong>Website:</strong> <strong>{siteConfig.name}</strong>’s site,
            which can be accessed via this URL: {siteConfig.url}
          </li>
          <li>
        ...
        <h2 id="collected-info">What Information Do We Collect?</h2>
        <p>
        ...
        <h2>
          When Does <strong>{siteConfig.name}</strong> Use End User Information
          from Third Parties?
        </h2>
        <p>
          <strong>{siteConfig.name}</strong> will collect End User Data
          necessary to provide the {siteConfig.name} services to our customers.
        </p>
        <p>
        ...
        <h2>
          When Does <strong>{siteConfig.name}</strong> Use Customer Information
          from Third Parties?
        </h2>
        <p>
          ...
          in becoming an <strong>{siteConfig.name}</strong> customer, we receive
          information from a third party that provides automated fraud detection
          services to {siteConfig.name}. We also occasionally collect
        ...
        <p>
          ...
          and business partners. If we are involved in a merger, asset sale, or
          other business reorganization, we may also share or transfer your
        ...
        <p>
          ...
          functions and provide services to us. We will likely share your
          personal information, and possibly some non-personal information, with
          these third parties to enable them to perform these services for us
          and for you.
        </p>
        <p>
          ...
          partners, application developers, and ad networks. We may also
        ...
        <p>
          <strong>{siteConfig.name}</strong> will collect personal information
        ...
        <p>
          ...
          commercial emails. By submitting your email address, you also agree to
        ...
        <p>
          We keep your information only as long as we need it to provide{" "}
          {siteConfig.name} to you and fulfill the purposes described in this
          policy. When we no longer need to use your information and there is no
        ...
        <p>
          ...
          <strong>{siteConfig.name}</strong> or guarantee that your information
        ...
        <p>
          <strong>{siteConfig.name}</strong> is incorporated in United Kingdom.
        ...
        <h2>
          ...
          <strong>{siteConfig.name}</strong> Service secure?
        </h2>
        <p>
        ...
        <p>
          ...
          information <strong>{siteConfig.name}</strong> collects depend on your
          relationship with <strong>{siteConfig.name}</strong>. Personnel may
        ...
        <h2>Personnel</h2>
        <p>
          If you are a <strong>{siteConfig.name}</strong> worker or applicant,
          we collect information you voluntarily provide to us. We use the
        ...
        <p>
          ...
          of the assets of <strong>{siteConfig.name}</strong> or any of its
          Corporate Affiliates (as defined herein), or that portion of{" "}
          <strong>{siteConfig.name}</strong> or any of its Corporate Affiliates
        ...
        <p>
          ...
          <strong>{siteConfig.name}</strong>, whether by ownership or otherwise.
        ...
        <h2>Governing Law </h2>
        <p>
          This Privacy Policy is governed by the laws of United Kingdom without
        ...
        <p>
          By using <strong>{siteConfig.name}</strong> or contacting us directly,
        ...
        <p>
          ...
          <strong>{siteConfig.name}</strong>. We are not responsible for the
        ...
        <h2>Cookies</h2>
        <p>
          <strong>{siteConfig.name}</strong> uses “Cookies” to identify the
        ...
        <p>
          ...
          you (for example, through our Service) before
        </p>
        <p>
          We make changes to this Privacy Policy and give you an opportunity to
          review them before they go into effect. Then, if you continue to use
          the Service, you will be bound by the updated Privacy Policy. If you
          do not want to agree to this or any updated Privacy Policy, you can
          delete your account.
        </p>
        ...
        <p>
          You acknowledge and agree that <strong>{siteConfig.name}</strong>{" "}
          ...
          <strong>{siteConfig.name}</strong> does not assume and shall not have
        ...
        <p>
          ...
          right thing to do. At <strong>{siteConfig.name}</strong> we strongly
        ...
        <p>
          ...
          requirements of GDPR. <strong>{siteConfig.name}</strong> processes or
